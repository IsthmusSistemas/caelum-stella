...
import static br.com.caelum.stella.boleto.bancos.Bancos.SICOOB;
import static br.com.caelum.stella.boleto.utils.StellaStringUtils.leftPadWithZeros;

/**
 * Gera dados de um boleto relativos ao Banco SICOOB.
 *
 *
...
public class Sicoob extends AbstractBanco implements Banco {
    ...
    private static final String NUMERO_SICOOB = SICOOB.getNumeroDoBanco();
    ...
    public String getNumeroFormatadoComDigito() {
        return DigitoBanco.getNumeroFormatadoComDigito(NUMERO_SICOOB);
    }
